 ...
 *
 * Aggregates secret requirements from VCS and trigger plugins.
...
export function getProjectSecretRequirements(
  ...
  // 1. VCS plugin requirements (always included based on project.vcs.type)
  ...
  // 2. Enabled trigger requirements
